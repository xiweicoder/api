...
import com.lfs.exception.ErrorResponse;
import com.lfs.model.request.BaseRequest;
import com.lfs.utils.SignUtils;
import lombok.Data;
...
public abstract class BaseService implements ApiService {
     ...
     * 网关HOST
     */
    private String gatewayHost = "https://xxx";
    ...
    private Map<String, String> getHeaders(String body, ApiClient apiClient) {
        ...
        hashMap.put("sign", SignUtils.getSign(encodedBody, apiClient.getSecretKey()));
        return hashMap;
    }
