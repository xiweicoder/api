package com.lfs.service.alipay;
...
import static com.lfs.constant.PayConstant.RESPONSE_CODE_SUCCESS;


/**
 * @Author: 西尾ink
 * @Date: 2024年08月24日 22:19
 * @Version: 1.0
 * @Description:
 */
@SpringBootTest
...
public class AliPayTest {
    ...
    void alipayQueryOrder() {
        ...
        if (tradeStatus.equals(PaymentStatusEnum.NOTPAY.getValue())) {
        ...
        if (tradeStatus.equals(PaymentStatusEnum.SUCCESS.getValue())) {
            // 订单已支付更新商户端的订单状态
            productOrderService.updateOrderStatusByOrderNo(OutTradeNo, PaymentStatusEnum.SUCCESS.getValue());
            // 补发积分到用户钱包
