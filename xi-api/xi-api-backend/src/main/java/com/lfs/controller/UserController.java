...
import com.lfs.annotation.AuthCheck;
import com.lfs.common.*;
import com.lfs.config.EmailConfig;
import com.lfs.constant.EmailConstant;
import com.lfs.exception.BusinessException;
import com.lfs.model.dto.user.*;
import com.lfs.model.entity.User;
import com.lfs.model.enums.UserAccountStatusEnum;
import com.lfs.model.vo.UserVO;
import com.lfs.service.UserService;
import com.lfs.utils.EmailUtil;
...
import static com.lfs.constant.UserConstant.ADMIN_ROLE;
...
public class UserController {
    ...
    public BaseResponse<UserVO> userEmailLogin(@RequestBody UserEmailLoginRequest userEmailLoginRequest, HttpServletRequest request) {
        ...
        redisTemplate.delete(EmailConstant.CAPTCHA_CACHE_KEY + userEmailLoginRequest.getEmailAccount());
        return ResultUtils.success(user);
    }
    ...
    public BaseResponse<UserVO> userUnBindEmail(@RequestBody UserUnBindEmailRequest userUnBindEmailRequest, HttpServletRequest request) {
        ...
        redisTemplate.delete(EmailConstant.CAPTCHA_CACHE_KEY + userUnBindEmailRequest.getEmailAccount());
        return ResultUtils.success(user);
    }
    ...
    public BaseResponse<Long> userEmailRegister(@RequestBody UserEmailRegisterRequest userEmailRegisterRequest) {
        ...
        redisTemplate.delete(EmailConstant.CAPTCHA_CACHE_KEY + userEmailRegisterRequest.getEmailAccount());
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Boolean> getCaptcha(String emailAccount) {
        ...
        try {
            ...
            redisTemplate.opsForValue().set(EmailConstant.CAPTCHA_CACHE_KEY + emailAccount, captcha, 5, TimeUnit.MINUTES);
