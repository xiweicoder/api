...
public class SentinelRulesManager {
    ...
    public void initFlowRules() {
        // 单 IP 查看题目列表限流规则
        ParamFlowRule rule = new ParamFlowRule(SentinelConstant.apiInterface)
    ...
    public void initDegradeRules() {
        // 单 IP 查看题目列表熔断规则
        DegradeRule slowCallRule = new DegradeRule(SentinelConstant.apiInterface)
        ...
        DegradeRule errorRateRule = new DegradeRule(SentinelConstant.apiInterface)
